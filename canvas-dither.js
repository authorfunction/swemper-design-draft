 ...
 * Unminified-code: https://github.com/NielsLeenheer/CanvasDither/blob/master/src/canvas-dither.js
 */
!(function (t) {
            ...
            bayer2x2(t, e) {
              ...
              for (let n = 0; n < t.data.length; n += 4) {
                const r =
                  ...
                  0.114 * t.data[n + 2];
                const o = (n / 4) % t.width;
                const d = Math.floor(n / 4 / t.width);

                // CHANGE: Use % 2 for width/height
                const f = Math.floor((r + a[o % 2][d % 2]) / 2) < e ? 0 : 255;
